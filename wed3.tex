...
\lstinputlisting[language={[Sharp]C}]{sourcecode/csharp/example_test.cs}
...
\begin{center}
	\includegraphics[width=0.23\textwidth]{img/FrontController.png}
\end{center}
...
\end{tight-itemize}
\textbf{Wichtig}: Multi-Threading beachten (z.B. DBContext ist nicht Thread-Safe).\\
